...
with open("resources/views/admin/shortlinks/partials/create-form.blade.php", "w") as f:
    f.write(html_code)

with open("resources/views/homeadminS/shortlink/create.blade.php", "r") as f:
    lines = f.readlines()

new_lines = lines[:36] + ["        @include('admin.shortlinks.partials.create-form')\n"] + lines[92:]
