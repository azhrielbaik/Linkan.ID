            ...
            <div class="card" style="margin-bottom: 0;">
                <div style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap;">
                    <div style="flex: 1; position: relative; min-width: 200px;">
                        ...
                        <input type="text" placeholder="{{ __('shortlink.search_placeholder') ?? 'Search your links...' }}" style="width: 100%; padding: 12px 12px 12px 40px; border: 1px solid var(--border-color); border-radius: 8px; font-family: inherit; font-size: 14px; box-sizing: border-box;">
                    </div>
                    <div style="width: 180px; position: relative; flex-shrink: 0;">
                        <select style="width: 100%; padding: 12px 32px 12px 16px; border: 1px solid var(--border-color); border-radius: 8px; font-family: inherit; font-size: 14px; background: #fff; cursor: pointer; appearance: none; color: #181818; box-sizing: border-box;">
                            <option value="">{{ __('shortlink.filter_all') ?? 'All Links' }}</option>
                            <option value="popular">{{ __('shortlink.filter_popular') ?? 'Most Popular' }}</option>
                            <option value="newest">{{ __('shortlink.filter_newest') ?? 'Newest' }}</option>
                        </select>
                ...
                <div class="engagement-list">
                    ...
                    >
                        ...
                        <div class="eng-actions">
                            ...
                            <a href="{{ route('shortlink.analytics', $link) }}" class="btn-icon" title="Analytics"><i class="fas fa-chart-bar"></i></a>
