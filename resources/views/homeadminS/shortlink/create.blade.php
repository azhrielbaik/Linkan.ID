    ...
    <div class="dashboard-grid">
        ...
        <div class="left-col">
            ...
            <div class="card search-filter-card" style="margin-bottom: 0;">
                <form method="GET" action="{{ route('shortlink.index') }}" id="search-filter-form">
                    <div style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap;">
                        <div style="flex: 1; position: relative; min-width: 200px;">
                            ...
                            @if(request('search'))
                                <a href="{{ route('shortlink.index', request()->except(['search', 'page'])) }}" style="position: absolute; right: 16px; top: 50%; transform: translateY(-50%); color: #999; text-decoration: none;"><i class="fas fa-times-circle"></i></a>
                            @endif
                        </div>
