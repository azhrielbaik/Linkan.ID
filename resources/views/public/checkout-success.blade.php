...
<head>
    ...
    <style>
        ...
        .animate-float-1 { animation: floatParticle 2.5s ease-in-out infinite; }
        .animate-float-2 { animation: floatParticle 3s ease-in-out infinite 0.4s; }
        .animate-float-3 { animation: floatParticle 3.5s ease-in-out infinite 0.8s; }
    </style>
</head>
    ...
    <div class="w-full max-w-[400px] bg-white rounded-[32px] shadow-2xl overflow-hidden flex flex-col relative px-6 py-10">
        ...
        <div class="relative flex justify-center items-center mt-2 mb-6 w-full h-32">
            ...
            <div class="absolute inset-0 overflow-hidden pointer-events-none">
                <!-- Dots -->
                <div class="absolute top-4 left-12 w-2.5 h-2.5 rounded-full bg-pink-400 animate-float-1"></div>
                <div class="absolute top-20 left-4 w-2 h-2 rounded-full bg-blue-600 animate-float-2"></div>
                <div class="absolute top-12 right-12 w-1.5 h-1.5 rounded-full bg-gray-300 animate-float-3"></div>
                <!-- Lines / Squiggles -->
                <div class="absolute top-16 left-16 w-4 h-1 bg-gray-300 rounded-full animate-float-2" style="--rot: 45deg;"></div>
                <div class="absolute top-8 right-16 w-5 h-1.5 bg-gray-200 rounded-full animate-float-1" style="--rot: -12deg;"></div>
                <div class="absolute bottom-6 right-8 w-3 h-1 bg-pink-500 rounded-full animate-float-3" style="--rot: -45deg;"></div>
                <div class="absolute bottom-4 left-10 w-2 h-2 rounded-full bg-purple-400 animate-float-1"></div>
            </div>

            <!-- Green Check Circle -->
            <div class="relative z-10 w-24 h-24 bg-[#34D399] rounded-full flex items-center justify-center shadow-[0_10px_20px_rgba(52,211,153,0.3)] animate-bounce-in">
