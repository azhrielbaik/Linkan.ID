...
with open("resources/views/admin/shortlinks/partials/list-items.blade.php", "w") as f:
    f.write(html_code)

with open("resources/views/homeadminS/shortlink/create.blade.php", "r") as f:
    lines = f.readlines()

new_lines = lines[:39] + ["            @include('admin.shortlinks.partials.list-items')\n"] + lines[107:]
