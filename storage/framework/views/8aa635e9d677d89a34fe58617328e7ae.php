...
<link rel="stylesheet" href="<?php echo e(asset('css/pages/myaccount.css')); ?>" data-turbo-track="reload">
<?php $__env->stopPush(); ?>
...
<!-- Form Account Detail -->
            <div class="account-detail">
                ...
                <form id="accountForm" action="<?php echo e(route('admin.account.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <div id="deleteConfirmationPopup" class="popup-overlay" style="display: none;">
                <div class="popup-content">
                    ...
                    <div class="popup-buttons">
                        ...
                        <form action="<?php echo e(route('admin.account.delete')); ?>" method="POST" style="display: inline;">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make("layouts.admin", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rakanyuka/Documents/PKL/Linkan/resources/views/homeadminS/myaccount.blade.php ENDPATH**/ ?>