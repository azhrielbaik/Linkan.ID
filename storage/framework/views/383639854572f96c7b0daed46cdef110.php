...
<head>
    ...
    <title>Reset Password - Linkan</title>
...
<div class="container">
    <div class="left-side">
        <img src="<?php echo e(asset('images/logohp.png')); ?>" alt="Reset Illustration" class="floating-animation">
    </div>
                ...
                <div class="error-message">
                    <ul style="padding-left: 20px; margin-bottom: 16px;">
                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li style="color: #dc3545;"><?php echo e($error); ?></li>
    ...
    <input
        ...
        readonly
        onfocus="this.blur()"
        style="color: #aaa; background-color: #f9f9f9; cursor: not-allowed;"
    >
</div>
...
<?php /**PATH C:\LINKAN_ID\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>