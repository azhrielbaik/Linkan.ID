            ...
            <table>
                ...
                <tbody id="productTableBody">
                    ...
                    <tr class="product-row" 
                        ...
                        <td><?php echo e($product->user->name ?? 'Unknown User'); ?></td>
                        <td>
                        ...
                        <td>
                            <?php if($product->verification_status == 'pending'): ?>
                                <div class="action-buttons">
                                    ...
                                    <form action="<?php echo e(route('platform-admin.verifikasi.verify', $product->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/rakanyuka/Documents/PKL/Linkan/resources/views/platformadmin/verifikasi.blade.php ENDPATH**/ ?>