...
<nav class="navbar">
    ...
    <div class="nav-links" id="navLinks">
        ...
        <a href="<?php echo e(route('login')); ?>" class="login">Sign In</a>
...
</script><?php /**PATH C:\Users\user\Documents\TUGAS PKL\linkan.id\Linkan.ID\resources\views/layout/header.blade.php ENDPATH**/ ?>