...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Level 1: Word wrapper spans */
        .hero-title > span {
            display: inline-block !important;
            white-space: nowrap !important;
        }

        /* Level 2: Character outer wrapper spans (clipping) */
        ...
        /* Level 3: Character inner spans (positioning) */
        .hero-title > span > span > span {
            position: relative !important;
            display: inline-block !important;
            vertical-align: bottom !important;
        }
    ...
    <section class="hero-section reveal">
        <div class="hero-container">
            <div class="hero-content">
                <h1 class="hero-title">Powering Creators<br>Economy</h1>
...
</html><?php /**PATH C:\Users\user\Documents\TUGAS PKL\Linkan.ID\resources\views/welcome.blade.php ENDPATH**/ ?>