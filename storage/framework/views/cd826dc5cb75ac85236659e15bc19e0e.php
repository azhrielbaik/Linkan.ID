...
<?php $__env->startPush("page-styles"); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/pages/orders.css')); ?>" data-turbo-track="reload">
<?php $__env->stopPush(); ?>
        ...
        <div class="page-orders">
            ...
            <div class="page-orders__content">
                <div class="page-orders__product-orders">
                    ...
                    <div class="page-orders__item" data-id="<?php echo e($transaction->id); ?>" data-status="<?php echo e($transaction->status); ?>" data-date="<?php echo e($transaction->created_at->format('Y-m-d')); ?>">
                        <img src="<?php echo e(asset('storage/' . $transaction->product->image)); ?>" alt="<?php echo e($transaction->product->title); ?>" class="page-orders__product-image">
                        <div class="page-orders__product-info">
                            <div class="page-orders__product-title"><?php echo e($transaction->product->title); ?></div>
                            <div class="page-orders__product-meta">
                                <?php echo e($transaction->buyer_name); ?> • <?php echo e($transaction->created_at->format('d M Y')); ?>

                            </div>
                        </div>
                        <button class="page-orders__btn-detail" onclick="loadOrderDetail(<?php echo e($transaction->id); ?>)">Detail</button>
                    </div>
...
<?php echo $__env->make("layouts.admin", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Documents\TUGAS PKL\Linkan.ID\resources\views/homeadminS/orders.blade.php ENDPATH**/ ?>